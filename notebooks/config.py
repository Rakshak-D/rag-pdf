...
class Config:
    ...
    reranker_ce_weight: float = 0.85       # CrossEncoder relevance (primary signal)
    reranker_fused_weight: float = 0.10    # Hybrid fusion score contribution
    ...
    # Must sum to 1.0.
    bm25_signal_max_weight: float = 0.45   # Weight for BM25 max-score signal
    bm25_signal_std_weight: float = 0.20   # Weight for BM25 score std-dev signal
    bm25_signal_spec_weight: float = 0.20  # Weight for corpus specificity signal
    bm25_signal_lex_weight: float = 0.15   # Weight for lexical query type signal
